...
from .layer import Conv2d_lr, Embedding, Linear, LoraLayer
    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        **optional_kwargs,
        ...
        if isinstance(target, Conv2d_lr):
    ...
    def _create_new_module(lora_config, adapter_name, target, **kwargs):
        ...
        if loaded_in_8bit and isinstance(target_base_layer, bnb.nn.Linear8bitLt):
            ...
            new_module = Conv2d_lr(target, adapter_name, **kwargs)
    ...
    def _svd_weighted_adapter(
        ...
        conv2d = isinstance(target, Conv2d_lr)
        if conv2d:
