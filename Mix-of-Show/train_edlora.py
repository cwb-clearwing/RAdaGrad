...
def train(root_path, args):
    ...
    if args.optimizer=='adamw':
        ...
        optimizer = RGD_Opt(EDLoRA_trainer.get_params_to_optimize(), **train_opt['optim_g'], pre=False)
    elif args.optimizer=='radagrad':
        print('Using Optimizer Riemannian AdaGraD')
        optimizer = RGD_Opt(EDLoRA_trainer.get_params_to_optimize(), **train_opt['optim_g'], pre=True)
